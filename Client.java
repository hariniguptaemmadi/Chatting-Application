...
public class Client implements ActionListener {
    ...
    Client() {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/itachi.jpg"));
        ...
        a1 = new JPanel(){
            ImageIcon background = new ImageIcon(ClassLoader.getSystemResource("icons/wallpaper1.jpg"));
    ...
    JPanel panel = new JPanel(); 
        ...
        JLabel output = new JLabel("<html><p style=\"width: 250px\">" + out + "</p></html>");
        output.setFont(new Font("Tahoma", Font.PLAIN, 16));
        output.setBackground(new Color(37, 211, 102)); // fixed color
